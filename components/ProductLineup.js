...
const products = [
  {
    ...
    index: '01',
    name: 'Yarn Cone Disc',
    description: 'Precision-moulded PPCP cone disk engineered for 3°, 4° and 5° paper cones and yarn cones. Functions as a cone insert, cone washer, and edge protector in one.',
    detail: 'Made from 60% recycled plastic, 30% virgin plastic, 10% hardening agents. Available as paper cone disk, yarn cone disk, and cone edge protector variants.',
  ...
  },
  {
    ...
    index: '02',
    name: 'PP Plastic\nTwine',
    description: 'Made from premium virgin grade material for higher meter per kg of twine bought.',
  ...
  },
  {
    ...
    description: 'Yarn cone cover made from PP, HM-HDPE and LDPE for delivering higher cover per kg of material.',
